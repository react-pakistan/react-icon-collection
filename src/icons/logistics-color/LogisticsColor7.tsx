...
const SvgLogisticsColor7 = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    id="logistics-color-7_svg__Layer_1"
    x={0}
    y={0}
    viewBox="0 0 256 256"
    xmlSpace="preserve"
  ...
  >
    <style>
      {
        ".logistics-color-7_svg__st0{fill:#9feaff}.logistics-color-7_svg__st1{fill:#48386a}.logistics-color-7_svg__st2{fill:#fff}"
      }
    </style>
    <path
      className="logistics-color-7_svg__st0"
    ...
    />
    <path
      className="logistics-color-7_svg__st1"
    ...
    />
    <path
      className="logistics-color-7_svg__st2"
    ...
    />
    <path className="logistics-color-7_svg__st2" d="M57.8 148.6h29V167h-29z" />
    <path
      className="logistics-color-7_svg__st1"
...
export default SvgLogisticsColor7;
