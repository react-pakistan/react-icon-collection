...
const SvgLogisticsGrey9 = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    id="logistics-grey-9_svg__Layer_1"
    x={0}
    y={0}
    viewBox="0 0 256 256"
    xmlSpace="preserve"
    ...
    {...props}
  >
    <style>{".logistics-grey-9_svg__st0{fill:#48386a}"}</style>
    <path
      className="logistics-grey-9_svg__st0"
