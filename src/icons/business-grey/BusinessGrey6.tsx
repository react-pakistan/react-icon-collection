...
const SvgBusinessGrey6 = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    id="business-grey-6_svg__Layer_1"
    x={0}
    y={0}
    viewBox="0 0 256 256"
    xmlSpace="preserve"
    ...
    {...props}
  >
    <style>{".business-grey-6_svg__st0{fill:#48386a}"}</style>
    <path
      className="business-grey-6_svg__st0"
