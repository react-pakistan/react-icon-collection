...
const SvgBusinessGrey1 = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    id="business-grey-1_svg__Layer_1"
    x={0}
    y={0}
    viewBox="0 0 256 256"
    xmlSpace="preserve"
    ...
    {...props}
  >
    <style>{".business-grey-1_svg__st0{fill:#48386a}"}</style>
    <path
      className="business-grey-1_svg__st0"
    ...
    <path
      className="business-grey-1_svg__st0"
      d="M249 196.8c-.8 0-1.5-.7-1.5-1.5v-1.5c0-.8.7-1.5 1.5-1.5s1.5.7 1.5 1.5v1.5c0 .8-.7 1.5-1.5 1.5zM15.3 182.9c-.3 0-.5-.2-.5-.5v-2.9c0-.3.2-.5.5-.5s.5.2.5.5v2.9c0 .3-.2.5-.5.5zM61.4 235.5H24.8c-5.5 0-10-4.5-10-10v-39.4c0-.3.2-.5.5-.5s.5.2.5.5v39.4c0 5 4 9 9 9h36.1v-34c0-.2.1-.4.3-.5 4.8-1.6 8.7-5.2 10.8-9.7.1-.2.3-.3.5-.3h40c.3 0 .5.2.5.5s-.2.5-.5.5H72.9c-2.2 4.5-6.2 8.1-10.9 9.8V235c-.1.3-.3.5-.6.5z"
    />
    <path
      className="business-grey-1_svg__st0"
    ...
    <path
      className="business-grey-1_svg__st0"
      d="M98.4 75.9h-29c-1.1 0-2-.9-2-2v-8.3c0-1.1.9-2 2-2h29c1.1 0 2 .9 2 2v8.3c0 1.1-.9 2-2 2zm-29-10.3v8.3h29v-8.3h-29zM186.6 75.9h-29c-1.1 0-2-.9-2-2v-8.3c0-1.1.9-2 2-2h29c1.1 0 2 .9 2 2v8.3c0 1.1-.9 2-2 2zm-29-10.3v8.3h29v-8.3h-29zM172.1 135.4H83.9c-.6 0-1-.4-1-1V99.5c0-.6.4-1 1-1h57c.6 0 1 .4 1 1s-.4 1-1 1h-56v32.9h86.2v-32.9H150c-.6 0-1-.4-1-1s.4-1 1-1h22.1c.6 0 1 .4 1 1v34.9c0 .6-.5 1-1 1z"
    />
    <path
      className="business-grey-1_svg__st0"
      d="M167.1 129.9H88.9c-.3 0-.5-.2-.5-.5v-24.9c0-.3.2-.5.5-.5h78.2c.3 0 .5.2.5.5v24.9c0 .3-.2.5-.5.5zm-77.7-1h77.2V105H89.4v23.9zM193.6 244.3H62.4c-.6 0-1-.4-1-1v-42.1c0-.4.3-.8.6-.9 4.4-1.7 8.1-5 10.2-9.2.2-.3.5-.5.9-.5h39.7c.6 0 1 .4 1 1s-.4 1-1 1h-39c-2.3 4.2-5.9 7.5-10.3 9.3v40.5h129.1v-40.5c-4.4-1.9-8-5.1-10.3-9.3h-50.1c-.6 0-1-.4-1-1s.4-1 1-1h50.7c.4 0 .7.2.9.5 2.1 4.2 5.8 7.5 10.2 9.2.4.1.6.5.6.9v42.1c0 .6-.5 1-1 1z"
    />
    <path
      className="business-grey-1_svg__st0"
      d="M188.6 243.8H67.4c-.3 0-.5-.2-.5-.5v-39c0-.2.1-.3.3-.4 3.3-1.9 6.3-4.5 8.4-7.7.1-.1.2-.2.4-.2h104c.2 0 .3.1.4.2 2.2 3.2 5.1 5.8 8.4 7.7.2.1.3.3.3.4v39c0 .3-.3.5-.5.5zm-120.7-1H188v-38.2c-3.3-1.9-6.2-4.5-8.3-7.6H76.3c-2.2 3.1-5 5.7-8.3 7.6v38.2zM123.2 192.5h-3.1c-.6 0-1-.4-1-1s.4-1 1-1h3.1c.6 0 1 .4 1 1s-.5 1-1 1z"
    />
  </svg>
);
