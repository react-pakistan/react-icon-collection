...
const SvgBusinessColor1 = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    id="business-color-1_svg__Layer_1"
    x={0}
    y={0}
    viewBox="0 0 256 256"
    xmlSpace="preserve"
  ...
  >
    <style>
      {
        ".business-color-1_svg__st0{fill:#fff}.business-color-1_svg__st1{fill:#48386a}.business-color-1_svg__st2{fill:#9feaff}"
      }
    </style>
    <path
      className="business-color-1_svg__st0"
    ...
    />
    <path
      className="business-color-1_svg__st1"
    ...
    />
    <path
      className="business-color-1_svg__st2"
