...
const SvgBusinessColor19 = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    id="business-color-19_svg__Layer_1"
    x={0}
    y={0}
    viewBox="0 0 256 256"
    xmlSpace="preserve"
  ...
  >
    <style>
      {
        ".business-color-19_svg__st0{fill:#fff}.business-color-19_svg__st1{fill:#48386a}.business-color-19_svg__st2{fill:#9feaff}"
      }
    </style>
    <path
      className="business-color-19_svg__st0"
    ...
    />
    <path
      className="business-color-19_svg__st1"
    ...
    />
    <path
      className="business-color-19_svg__st2"
    ...
    <path
      className="business-color-19_svg__st2"
      d="M117.6 36.8c-2.6 0-4.7-2.1-4.7-4.7V13.9c0-2.6 2.1-4.7 4.7-4.7 1.3 0 2.4.5 3.3 1.4.9.9 1.4 2.1 1.4 3.3v18.2c0 2.6-2.1 4.7-4.7 4.7zM204.4 21.4v10.7c0 2.6-2.1 4.7-4.7 4.7s-4.7-2.1-4.7-4.7V13.9c0-2.6 2.1-4.7 4.7-4.7 1.3 0 2.4.5 3.3 1.4.9.9 1.4 2.1 1.4 3.3v7.5zM158.6 36.8c-2.6 0-4.7-2.1-4.7-4.7V13.9c0-2.6 2.1-4.7 4.7-4.7s4.7 2.1 4.7 4.7v18.2c.1 2.6-2 4.7-4.7 4.7zM76.6 36.8c-2.6 0-4.7-2.1-4.7-4.7V13.9c0-2.6 2.1-4.7 4.7-4.7s4.7 2.1 4.7 4.7v18.2c0 2.6-2.1 4.7-4.7 4.7zM40.3 21.4v10.7c0 2.6-2.1 4.7-4.7 4.7s-4.7-2.1-4.7-4.7V13.9c0-2.6 2.1-4.7 4.7-4.7 1.3 0 2.4.5 3.3 1.4.9.9 1.4 2.1 1.4 3.3v7.5z"
    />
    <path
      className="business-color-19_svg__st1"
    ...
    <path
      className="business-color-19_svg__st1"
      d="M196.7 37.3c-2.9 0-5.2-2.3-5.2-5.2V13.9c0-2.9 2.3-5.2 5.2-5.2 1.4 0 2.7.5 3.7 1.5s1.5 2.3 1.5 3.7v2.9c0 .3-.2.5-.5.5s-.5-.2-.5-.5v-2.9c0-1.1-.4-2.2-1.2-3-.8-.8-1.9-1.2-3-1.2-2.3 0-4.2 1.9-4.2 4.2v18.2c0 2.3 1.9 4.2 4.2 4.2 2.3 0 4.2-1.9 4.2-4.2V21.4c0-.3.2-.5.5-.5s.5.2.5.5v10.7c0 2.9-2.4 5.2-5.2 5.2zM155.7 42.9c-5.9 0-10.7-4.8-10.7-10.7V13.9c0-5.9 4.8-10.7 10.7-10.7 5.9 0 10.8 4.8 10.8 10.7v18.2c-.1 5.9-4.9 10.8-10.8 10.8zm0-37.8c-4.8 0-8.7 3.9-8.7 8.7V32c0 4.8 3.9 8.7 8.7 8.7 4.8 0 8.8-3.9 8.8-8.7V13.9c-.1-4.8-4-8.8-8.8-8.8z"
    />
    <path
      className="business-color-19_svg__st1"
    ...
    <path
      className="business-color-19_svg__st1"
      d="M183.3 178c-.6 0-1-.4-1-1v-27c0-.6.4-1 1-1s1 .4 1 1v27c0 .6-.4 1-1 1z"
    />
    <g>
      <path
        className="business-color-19_svg__st1"
        d="M209.4 210.5c-.3 0-.5-.1-.7-.3l-21.4-21.4c-.4-.4-.4-1 0-1.4s1-.4 1.4 0l21.4 21.4c.4.4.4 1 0 1.4-.1.2-.4.3-.7.3z"
      />
    </g>
  </svg>
);
