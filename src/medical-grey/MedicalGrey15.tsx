...
const SvgMedicalGrey15 = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      <style>
        {
          ".MedicalGrey15_svg__cls-1{fill:none;stroke:#000;stroke-linecap:round;stroke-linejoin:round;stroke-width:2px}"
        }
      </style>
    </defs>
...
export default SvgMedicalGrey15;
