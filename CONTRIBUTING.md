...
The [issue tracker](https://github.com/Taimoormk/react-commons-collection/issues) is
...
1.  [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
    ...
    git clone https://github.com/<your-username>/react-commons-collection.git
    # Navigate to the newly cloned directory
    cd react-commons-collection
    # Assign the original repo to a remote called "upstream"
    git remote add upstream https://github.com/Taimoormk/react-commons-collection.git
    ```
...
owners to license your work under the terms of the [MIT License](https://github.com/Taimoormk/react-commons-collection/blob/master/LICENSE.md).
